...
/* harmony export */ });
/* unused harmony exports Bleed, Callout, Collapse, Navbar, NotFoundPage, ServerSideErrorPage, Tab, Tabs, ThemeSwitch, useConfig */
...
/* harmony import */ var _reach_skip_nav__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(3129);
...
/* harmony import */ var github_slugger__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(8904);
/* harmony import */ var github_slugger__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(github_slugger__WEBPACK_IMPORTED_MODULE_15__);
/* harmony import */ var scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(3324);
/* harmony import */ var scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_16__);
/* harmony import */ var match_sorter__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(5875);
/* harmony import */ var match_sorter__WEBPACK_IMPORTED_MODULE_17___default = /*#__PURE__*/__webpack_require__.n(match_sorter__WEBPACK_IMPORTED_MODULE_17__);
/* harmony import */ var intersection_observer__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(4916);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_mdx_js_react__WEBPACK_IMPORTED_MODULE_4__, _headlessui_react__WEBPACK_IMPORTED_MODULE_11__]);
([_mdx_js_react__WEBPACK_IMPORTED_MODULE_4__, _headlessui_react__WEBPACK_IMPORTED_MODULE_11__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function Head() {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(next_seo__WEBPACK_IMPORTED_MODULE_14__.NextSeo, __spreadValues({
    title: config.title,
    description: frontMatter.description,
    canonical: frontMatter.canonical,
    openGraph: frontMatter.openGraph
  }, (_a = config.useNextSeoProps) == null ? void 0 : _a.call(config))), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((next_head__WEBPACK_IMPORTED_MODULE_13___default()), null, config.faviconGlyph ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("link", {
    rel: "icon",
...
var classes3 = {
  ...
  active: clsx__WEBPACK_IMPORTED_MODULE_3___default()("nx-subpixel-antialiased nx-font-medium"),
...
function File({
  ...
  const slugger = new (github_slugger__WEBPACK_IMPORTED_MODULE_15___default())();
...
function Sidebar({
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (activeElement && (window.innerWidth > 767 || menu)) {
      const scroll = () => {
        scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_16___default()(activeElement, {
          block: "center",
          inline: "center",
          scrollMode: "always",
...
function TOC({ headings, filePath }) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (anchor) {
      scroll_into_view_if_needed__WEBPACK_IMPORTED_MODULE_16___default()(anchor, {
        behavior: "smooth",
        block: "center",
        inline: "center",
        scrollMode: "always",
...
function MatchSorterSearch({
  ...
  const results = (0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(
    () => search ? (0,match_sorter__WEBPACK_IMPORTED_MODULE_17__.matchSorter)(directories, search, { keys: ["title"] }).map(
      ({ route, title }) => ({
        id: route + title,
        route,
...
var DEFAULT_THEME = {
  ...
  gitTimestamp({ timestamp }) {
    ...
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, "Last updated on", " ", timestamp.toLocaleDateString(locale, {
      day: "numeric",
      month: "long",
      year: "numeric"
    }));
...
var Pre = (_a) => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, filename && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    ...
    className: "nx-pointer-events-none nx-h-4 nx-w-4"
  })), value && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(CopyToClipboard, {
    value
  })));
};
...
var Body = ({
  ...
  const gitTimestampEl = date ? /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
...
var InnerLayout = ({
  ...
  }), tocEl, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_reach_skip_nav__WEBPACK_IMPORTED_MODULE_19__/* .SkipNavContent */ .fN, null), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Body, {
    themeContext,
...
var devUtils = __webpack_require__(2143);
